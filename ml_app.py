...
def run_ml_app():
	...
	with st.expander("Resultados de la Predicción Regresión Logística"):
	...
	with st.expander("Resultados de la Predicción Árbol de Decisión"):
		single_sample = np.array(encoded_result).reshape(1,-1)

  		#destree_model = load_model("models/decision_tree_model_diabetes_21_oct_2020.pkl") --> no me funciona
		prediction = loaded_model.predict(single_sample)
		pred_prob = loaded_model.predict_proba(single_sample)
		st.write(prediction)
